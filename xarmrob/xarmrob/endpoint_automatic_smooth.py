...
class EndpointAutomatic(Node): 
    def __init__(self): 
        ...
        # SVG File Name
        self.filename = self.declare_parameter('path_svg_file','/home/pi/ros2_ws/src/xarmrob/xarmrob/W_svg.svg').value
        #self.filename = self.declare_parameter('path_svg_file','/home/pi/ros2_ws/src/xarmrob/xarmrob/xarm_svg.svg').value

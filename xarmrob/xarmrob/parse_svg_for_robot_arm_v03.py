...
# All-inclusive function to get endpoints from an SVG file.    
def convert_svg_to_endpoints(svg_file, xlength=dx_arena, ylength=dy_arena, rmin = rmin_default, rmax = rmax_default):
